...
namespace ZentavioCRM.Api.Controllers.Platform
{
    ...
    /// outside the normal per-tenant JWT/permission scheme — requires a Platform Admin session
    /// (see <see cref="PlatformAuthorizationPolicies.PlatformAdmin"/>) instead, since these
    /// operations happen before any tenant — or its users — exist yet.
