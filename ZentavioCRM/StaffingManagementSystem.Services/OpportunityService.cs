...
namespace ZentavioCRM.Services
{
    ...
    public class OpportunityService : IOpportunityService
    {
            ...
            string? sortBy = null, bool sortDescending = true)
        {
            ...
            var (items, totalCount) = await _opportunityRepository.SearchAsync(search, stage, customerId, assignedToUserId, page, pageSize, accessScope, sortBy, sortDescending);
